...
<html lang="en">
  <head>
    ...
    <title>Tela de exclusão de produto</title>
  </head>
  <body>
      ...
      <form action="excluir.php" method="post">
        ...
        <input type="hidden" name="id" value='.$row['id'].'>
            ...
            <div class="mb-3">
              ...
              name="descricao" rows="3" disabled >'.$row['descricao'].'</textarea>
            </div>
             <div class="mb-3">
            ...
            <div class="row">
            <div class="col">
                <a href="consultaProduto.php"  class="btn btn-success" role="button">Não</a>
            </div>
            <div class="col">
